import{t as e}from"./rolldown-runtime.BvHXOKAc.mjs";import{C as t,P as n,c as r,l as i,o as a,v as o}from"./react.ZuBMAs26.mjs";import{S as s,t as c}from"./motion.BXVtp1rV.mjs";import{K as l,O as u,o as d}from"./framer.C9Y58ia_.mjs";function f({text:e,transition:t,stagger:a,reverse:c,font:l,color:u,textTransform:d,tag:f,padding:p}){let[m,h]=n(!1),g=`rolling-text-inner-${o().replace(/:/g,``)}`,_=f,v=l?.fontSize??`16px`;l?.letterSpacing;let y=l?.lineHeight,b=l?.fontFamily??`Inter`,x=parseInt(v,10)||16,S;if(typeof y==`number`)S=x*y;else if(typeof y==`string`&&y.includes(`em`))S=x*(parseFloat(y)||1.2);else if(typeof y==`string`){let e=parseFloat(y);S=isNaN(e)?y:`${e}px`}else S=x*1.2;let C=typeof S==`number`?`${S}px`:S,w=`-${C}`,T=`
    .${g} {
      --font-size: ${v};
      --text: ${u};
      --line-height-abs: ${C};
